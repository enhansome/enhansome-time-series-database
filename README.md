...
|      Atlas      |          <https://github.com/Netflix/atlas> ⭐ 3,562 \| 🐛 9 \| 🌐 Scala \| 📅 2026-08-13          | maintained |    scala   |              memory              |    http    |            stack            |  apache-2.0 |
...
|      Citus      |         <https://github.com/citusdata/citus> ⭐ 12,703 \| 🐛 1,065 \| 🌐 C \| 📅 2026-08-17        |   active   |      c     |            postgresql            |     tcp    |             sql             |   agpl-3.0  |
|    ClickHouse   |     <https://github.com/ClickHouse/ClickHouse> ⭐ 49,315 \| 🐛 6,911 \| 🌐 C++ \| 📅 2026-08-18    |   active   |     c++    |              localfs             |     tcp    |             sql             |  apache-2.0 |
|      Cortex     |       <https://github.com/cortexproject/cortex> ⭐ 5,850 \| 🐛 346 \| 🌐 Go \| 📅 2026-08-18       |   active   |     go     |  s3,cassandra,bigtable,dynamodb  |    http    |            promql           |  apache-2.0 |
|     CrateDB     |           <https://github.com/crate/crate> ⭐ 4,418 \| 🐛 337 \| 🌐 Java \| 📅 2026-08-18          |   active   |    java    |         elasticsearch,s3         |     tcp    |             sql             |  apache-2.0 |
|   DalmatinerDB  |    <https://github.com/dalmatinerdb/dalmatinerdb> ⭐ 692 \| 🐛 28 \| 🌐 Erlang \| 📅 2019-02-11    | maintained |   erlang   |              localfs             |    http    |             text            |     mit     |
|      FiloDB     |          <https://github.com/filodb/FiloDB> ⭐ 1,467 \| 🐛 70 \| 🌐 Scala \| 📅 2026-08-18         |   active   |    scala   |             cassandra            |    http    |       promql,metricsql      |  apache-2.0 |
...
|     InfluxDB    |     <https://github.com/influxdata/influxdb> ⭐ 31,703 \| 🐛 2,148 \| 🌐 Rust \| 📅 2026-08-17     |   active   |     go     |              localfs             |    http    |        influxql,flux        |     mit     |
|      IoTDB      |     <https://github.com/apache/incubator-iotdb> ⭐ 6,381 \| 🐛 747 \| 🌐 Java \| 📅 2026-08-18     |   active   |    java    |           hdfs,localfs           |     tcp    |             sql             |  apache-2.0 |
...
|        M3       |              <https://github.com/m3db/m3> ⭐ 4,892 \| 🐛 220 \| 🌐 Go \| 📅 2026-08-17             |   active   |     go     |              localfs             |    http    | promql,graphite,m3query,sql |  apache-2.0 |
...
|   Apache Pinot  |    <https://github.com/apache/incubator-pinot> ⭐ 6,122 \| 🐛 1,429 \| 🌐 Java \| 📅 2026-08-18    |   active   |    java    |           s3,hdfs,azdls          |    http    |             pql             |  apache-2.0 |
...
|    Prometheus   |      <https://github.com/prometheus/prometheus> ⭐ 65,734 \| 🐛 870 \| 🌐 Go \| 📅 2026-08-18      |   active   |     go     |              localfs             | prometheus |            promql           |  apache-2.0 |
|     QuestDB     |        <https://github.com/questdb/questdb> ⭐ 17,262 \| 🐛 924 \| 🌐 Java \| 📅 2026-08-18        |   active   |    java    |              localfs             |  postgres  |             sql             |  apache-2.0 |
...
|     TDengine    |         <https://github.com/taosdata/TDengine> ⭐ 25,068 \| 🐛 447 \| 🌐 C \| 📅 2026-08-16        |   active   |      c     |              localfs             |     tcp    |             sql             |   agpl-3.0  |
|      Tgres      |              <https://github.com/tgres/tgres> ⭐ 513 \| 🐛 5 \| 🌐 Go \| 📅 2021-12-22             |    dead    |     go     |            postgresql            |     tcp    |             sql             |  apache-2.0 |
|      Thanos     |         <https://github.com/thanos-io/thanos> ⭐ 14,180 \| 🐛 878 \| 🌐 Go \| 📅 2026-08-17        |   active   |     go     |            localfs,s3            |  http,grpc |            promql           |  apache-2.0 |
...
|   TimescaleDB   |       <https://github.com/timescale/timescaledb> ⭐ 23,344 \| 🐛 386 \| 🌐 C \| 📅 2026-08-18      |   active   |      c     |            postgresql            |  postgres  |             sql             |  apache-2.0 |
...
| VictoriaMetrics | <https://github.com/VictoriaMetrics/VictoriaMetrics> ⭐ 17,559 \| 🐛 769 \| 🌐 Go \| 📅 2026-08-18 |   active   |     go     |              localfs             |    http    |       promql,metricsql      |  apache-2.0 |
...
* [awesome big data](https://github.com/onurakpolat/awesome-bigdata#time-series-databases) ⭐ 14,531 | 🐛 2 | 📅 2026-07-31
* [awesome db](https://github.com/numetriclabz/awesome-db) ⭐ 1,377 | 🐛 38 | 📅 2024-03-04
* [dbdb.io](https://github.com/cmu-db/dbdb.io) ⭐ 576 | 🐛 38 | 🌐 Python | 📅 2026-08-17 A database for all the databases by [@apavlo](https://github.com/apavlo) from [CMU DB](https://db.cs.cmu.edu/)
