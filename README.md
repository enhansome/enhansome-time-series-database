...
|      Atlas      |          <https://github.com/Netflix/atlas> ⭐ 3,563 \| 🐛 8 \| 🌐 Scala \| 📅 2026-09-10          | maintained |    scala   |              memory              |    http    |            stack            |  apache-2.0 |
...
|      Citus      |         <https://github.com/citusdata/citus> ⭐ 12,759 \| 🐛 1,070 \| 🌐 C \| 📅 2026-09-10        |   active   |      c     |            postgresql            |     tcp    |             sql             |   agpl-3.0  |
|    ClickHouse   |     <https://github.com/ClickHouse/ClickHouse> ⭐ 49,798 \| 🐛 7,517 \| 🌐 C++ \| 📅 2026-09-10    |   active   |     c++    |              localfs             |     tcp    |             sql             |  apache-2.0 |
|      Cortex     |       <https://github.com/cortexproject/cortex> ⭐ 5,861 \| 🐛 349 \| 🌐 Go \| 📅 2026-09-10       |   active   |     go     |  s3,cassandra,bigtable,dynamodb  |    http    |            promql           |  apache-2.0 |
|     CrateDB     |           <https://github.com/crate/crate> ⭐ 4,435 \| 🐛 332 \| 🌐 Java \| 📅 2026-09-10          |   active   |    java    |         elasticsearch,s3         |     tcp    |             sql             |  apache-2.0 |
|   DalmatinerDB  |    <https://github.com/dalmatinerdb/dalmatinerdb> ⭐ 691 \| 🐛 28 \| 🌐 Erlang \| 📅 2019-02-11    | maintained |   erlang   |              localfs             |    http    |             text            |     mit     |
|      FiloDB     |          <https://github.com/filodb/FiloDB> ⭐ 1,467 \| 🐛 69 \| 🌐 Scala \| 📅 2026-09-10         |   active   |    scala   |             cassandra            |    http    |       promql,metricsql      |  apache-2.0 |
...
|     InfluxDB    |     <https://github.com/influxdata/influxdb> ⭐ 31,728 \| 🐛 2,165 \| 🌐 Rust \| 📅 2026-09-10     |   active   |     go     |              localfs             |    http    |        influxql,flux        |     mit     |
|      IoTDB      |     <https://github.com/apache/incubator-iotdb> ⭐ 6,393 \| 🐛 740 \| 🌐 Java \| 📅 2026-09-10     |   active   |    java    |           hdfs,localfs           |     tcp    |             sql             |  apache-2.0 |
...
|   Apache Pinot  |    <https://github.com/apache/incubator-pinot> ⭐ 6,134 \| 🐛 1,410 \| 🌐 Java \| 📅 2026-09-10    |   active   |    java    |           s3,hdfs,azdls          |    http    |             pql             |  apache-2.0 |
...
|    Prometheus   |      <https://github.com/prometheus/prometheus> ⭐ 66,025 \| 🐛 890 \| 🌐 Go \| 📅 2026-09-10      |   active   |     go     |              localfs             | prometheus |            promql           |  apache-2.0 |
|     QuestDB     |        <https://github.com/questdb/questdb> ⭐ 17,315 \| 🐛 951 \| 🌐 Java \| 📅 2026-09-10        |   active   |    java    |              localfs             |  postgres  |             sql             |  apache-2.0 |
...
|     TDengine    |         <https://github.com/taosdata/TDengine> ⭐ 25,107 \| 🐛 434 \| 🌐 C \| 📅 2026-09-10        |   active   |      c     |              localfs             |     tcp    |             sql             |   agpl-3.0  |
|      Tgres      |              <https://github.com/tgres/tgres> ⭐ 511 \| 🐛 5 \| 🌐 Go \| 📅 2021-12-22             |    dead    |     go     |            postgresql            |     tcp    |             sql             |  apache-2.0 |
|      Thanos     |         <https://github.com/thanos-io/thanos> ⭐ 14,204 \| 🐛 901 \| 🌐 Go \| 📅 2026-09-10        |   active   |     go     |            localfs,s3            |  http,grpc |            promql           |  apache-2.0 |
...
|   TimescaleDB   |       <https://github.com/timescale/timescaledb> ⭐ 23,505 \| 🐛 391 \| 🌐 C \| 📅 2026-09-10      |   active   |      c     |            postgresql            |  postgres  |             sql             |  apache-2.0 |
...
| VictoriaMetrics | <https://github.com/VictoriaMetrics/VictoriaMetrics> ⭐ 17,692 \| 🐛 798 \| 🌐 Go \| 📅 2026-09-10 |   active   |     go     |              localfs             |    http    |       promql,metricsql      |  apache-2.0 |
...
* [awesome big data](https://github.com/onurakpolat/awesome-bigdata#time-series-databases) ⭐ 14,624 | 🐛 5 | 📅 2026-07-31
* [awesome db](https://github.com/numetriclabz/awesome-db) ⭐ 1,373 | 🐛 40 | 📅 2024-03-04
* [dbdb.io](https://github.com/cmu-db/dbdb.io) ⭐ 578 | 🐛 35 | 🌐 Python | 📅 2026-09-09 A database for all the databases by [@apavlo](https://github.com/apavlo) from [CMU DB](https://db.cs.cmu.edu/)
