...
|      Arctic     |        <https://github.com/man-group/arctic> ⭐ 3,087 \| 🐛 97 \| 🌐 Python \| 📅 2024-04-08       |   active   |   python   |              mongodb             |     tcp    |            python           |     lgpl    |
|      Argus      |                               <https://github.com/salesforce/Argus>                               |    dead    |    java    |               hbase              |    http    |             json            |     bsd     |
|      Atlas      |          <https://github.com/Netflix/atlas> ⭐ 3,562 \| 🐛 8 \| 🌐 Scala \| 📅 2026-09-10          | maintained |    scala   |              memory              |    http    |            stack            |  apache-2.0 |
...
|      Citus      |         <https://github.com/citusdata/citus> ⭐ 12,768 \| 🐛 1,073 \| 🌐 C \| 📅 2026-09-14        |   active   |      c     |            postgresql            |     tcp    |             sql             |   agpl-3.0  |
|    ClickHouse   |     <https://github.com/ClickHouse/ClickHouse> ⭐ 49,886 \| 🐛 7,562 \| 🌐 C++ \| 📅 2026-09-14    |   active   |     c++    |              localfs             |     tcp    |             sql             |  apache-2.0 |
|      Cortex     |       <https://github.com/cortexproject/cortex> ⭐ 5,862 \| 🐛 344 \| 🌐 Go \| 📅 2026-09-14       |   active   |     go     |  s3,cassandra,bigtable,dynamodb  |    http    |            promql           |  apache-2.0 |
|     CrateDB     |           <https://github.com/crate/crate> ⭐ 4,435 \| 🐛 323 \| 🌐 Java \| 📅 2026-09-14          |   active   |    java    |         elasticsearch,s3         |     tcp    |             sql             |  apache-2.0 |
...
|     InfluxDB    |     <https://github.com/influxdata/influxdb> ⭐ 31,740 \| 🐛 2,165 \| 🌐 Rust \| 📅 2026-09-10     |   active   |     go     |              localfs             |    http    |        influxql,flux        |     mit     |
|      IoTDB      |     <https://github.com/apache/incubator-iotdb> ⭐ 6,396 \| 🐛 741 \| 🌐 Java \| 📅 2026-09-14     |   active   |    java    |           hdfs,localfs           |     tcp    |             sql             |  apache-2.0 |
...
|        M3       |              <https://github.com/m3db/m3> ⭐ 4,896 \| 🐛 228 \| 🌐 Go \| 📅 2026-08-17             |   active   |     go     |              localfs             |    http    | promql,graphite,m3query,sql |  apache-2.0 |
...
|   Apache Pinot  |    <https://github.com/apache/incubator-pinot> ⭐ 6,137 \| 🐛 1,376 \| 🌐 Java \| 📅 2026-09-14    |   active   |    java    |           s3,hdfs,azdls          |    http    |             pql             |  apache-2.0 |
...
|    Prometheus   |      <https://github.com/prometheus/prometheus> ⭐ 66,071 \| 🐛 882 \| 🌐 Go \| 📅 2026-09-14      |   active   |     go     |              localfs             | prometheus |            promql           |  apache-2.0 |
|     QuestDB     |        <https://github.com/questdb/questdb> ⭐ 17,321 \| 🐛 950 \| 🌐 Java \| 📅 2026-09-14        |   active   |    java    |              localfs             |  postgres  |             sql             |  apache-2.0 |
...
|     TDengine    |         <https://github.com/taosdata/TDengine> ⭐ 25,115 \| 🐛 434 \| 🌐 C \| 📅 2026-09-12        |   active   |      c     |              localfs             |     tcp    |             sql             |   agpl-3.0  |
|      Tgres      |              <https://github.com/tgres/tgres> ⭐ 511 \| 🐛 5 \| 🌐 Go \| 📅 2021-12-22             |    dead    |     go     |            postgresql            |     tcp    |             sql             |  apache-2.0 |
|      Thanos     |         <https://github.com/thanos-io/thanos> ⭐ 14,203 \| 🐛 907 \| 🌐 Go \| 📅 2026-09-11        |   active   |     go     |            localfs,s3            |  http,grpc |            promql           |  apache-2.0 |
...
|   TimescaleDB   |       <https://github.com/timescale/timescaledb> ⭐ 23,526 \| 🐛 389 \| 🌐 C \| 📅 2026-09-14      |   active   |      c     |            postgresql            |  postgres  |             sql             |  apache-2.0 |
...
| VictoriaMetrics | <https://github.com/VictoriaMetrics/VictoriaMetrics> ⭐ 17,714 \| 🐛 793 \| 🌐 Go \| 📅 2026-09-14 |   active   |     go     |              localfs             |    http    |       promql,metricsql      |  apache-2.0 |
...
* [awesome big data](https://github.com/onurakpolat/awesome-bigdata#time-series-databases) ⭐ 14,637 | 🐛 5 | 📅 2026-07-31
* [awesome db](https://github.com/numetriclabz/awesome-db) ⭐ 1,373 | 🐛 40 | 📅 2024-03-04
* [dbdb.io](https://github.com/cmu-db/dbdb.io) ⭐ 580 | 🐛 35 | 🌐 Python | 📅 2026-09-09 A database for all the databases by [@apavlo](https://github.com/apavlo) from [CMU DB](https://db.cs.cmu.edu/)
