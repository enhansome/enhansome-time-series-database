...
|      Arctic     |        <https://github.com/man-group/arctic> ⭐ 3,084 \| 🐛 97 \| 🌐 Python \| 📅 2024-04-08       |   active   |   python   |              mongodb             |     tcp    |            python           |     lgpl    |
|      Argus      |                               <https://github.com/salesforce/Argus>                               |    dead    |    java    |               hbase              |    http    |             json            |     bsd     |
|      Atlas      |          <https://github.com/Netflix/atlas> ⭐ 3,560 \| 🐛 8 \| 🌐 Scala \| 📅 2026-08-11          | maintained |    scala   |              memory              |    http    |            stack            |  apache-2.0 |
...
|      Citus      |         <https://github.com/citusdata/citus> ⭐ 12,685 \| 🐛 1,054 \| 🌐 C \| 📅 2026-08-12        |   active   |      c     |            postgresql            |     tcp    |             sql             |   agpl-3.0  |
|    ClickHouse   |     <https://github.com/ClickHouse/ClickHouse> ⭐ 49,205 \| 🐛 6,897 \| 🌐 C++ \| 📅 2026-08-13    |   active   |     c++    |              localfs             |     tcp    |             sql             |  apache-2.0 |
|      Cortex     |       <https://github.com/cortexproject/cortex> ⭐ 5,848 \| 🐛 334 \| 🌐 Go \| 📅 2026-08-11       |   active   |     go     |  s3,cassandra,bigtable,dynamodb  |    http    |            promql           |  apache-2.0 |
|     CrateDB     |           <https://github.com/crate/crate> ⭐ 4,417 \| 🐛 329 \| 🌐 Java \| 📅 2026-08-12          |   active   |    java    |         elasticsearch,s3         |     tcp    |             sql             |  apache-2.0 |
|   DalmatinerDB  |    <https://github.com/dalmatinerdb/dalmatinerdb> ⭐ 692 \| 🐛 28 \| 🌐 Erlang \| 📅 2019-02-11    | maintained |   erlang   |              localfs             |    http    |             text            |     mit     |
|      FiloDB     |          <https://github.com/filodb/FiloDB> ⭐ 1,466 \| 🐛 70 \| 🌐 Scala \| 📅 2026-08-08         |   active   |    scala   |             cassandra            |    http    |       promql,metricsql      |  apache-2.0 |
|      Flint      |         <https://github.com/twosigma/flint> ⭐ 1,173 \| 🐛 44 \| 🌐 Scala \| 📅 2020-07-03         | maintained |    scala   |               spark              |    http    |             json            |  apache-2.0 |
...
|     InfluxDB    |     <https://github.com/influxdata/influxdb> ⭐ 31,689 \| 🐛 2,147 \| 🌐 Rust \| 📅 2026-08-11     |   active   |     go     |              localfs             |    http    |        influxql,flux        |     mit     |
|      IoTDB      |     <https://github.com/apache/incubator-iotdb> ⭐ 6,378 \| 🐛 748 \| 🌐 Java \| 📅 2026-08-13     |   active   |    java    |           hdfs,localfs           |     tcp    |             sql             |  apache-2.0 |
...
|      LinDB      |            <https://github.com/lindb/lindb> ⭐ 3,067 \| 🐛 11 \| 🌐 Go \| 📅 2026-07-27            |   active   |     go     |              localfs             |    http    |             sql             |  apache-2.0 |
|        M3       |              <https://github.com/m3db/m3> ⭐ 4,893 \| 🐛 219 \| 🌐 Go \| 📅 2026-06-17             |   active   |     go     |              localfs             |    http    | promql,graphite,m3query,sql |  apache-2.0 |
...
|     OpenTSDB    |        <https://github.com/OpenTSDB/opentsdb> ⭐ 5,066 \| 🐛 538 \| 🌐 Java \| 📅 2024-12-12       | maintained |    java    |               hbase              |  http,tcp  |             json            |     lgpl    |
|   Apache Pinot  |    <https://github.com/apache/incubator-pinot> ⭐ 6,124 \| 🐛 1,430 \| 🌐 Java \| 📅 2026-08-12    |   active   |    java    |           s3,hdfs,azdls          |    http    |             pql             |  apache-2.0 |
|     PinusDB     |           <https://github.com/pinusdb/pinusdb> ⭐ 120 \| 🐛 0 \| 🌐 C++ \| 📅 2024-03-19           | maintained |     c++    |              localfs             |     tcp    |             sql             |   gpl-3.0   |
|    PipelineDB   |       <https://github.com/pipelinedb/pipelinedb> ⭐ 2,660 \| 🐛 133 \| 🌐 C \| 📅 2022-02-20       |    dead    |      c     |            postgresql            |     tcp    |             sql             |  apache-2.0 |
|    Prometheus   |      <https://github.com/prometheus/prometheus> ⭐ 65,723 \| 🐛 889 \| 🌐 Go \| 📅 2026-08-12      |   active   |     go     |              localfs             | prometheus |            promql           |  apache-2.0 |
|     QuestDB     |        <https://github.com/questdb/questdb> ⭐ 17,253 \| 🐛 929 \| 🌐 Java \| 📅 2026-08-12        |   active   |    java    |              localfs             |  postgres  |             sql             |  apache-2.0 |
...
|     TDengine    |         <https://github.com/taosdata/TDengine> ⭐ 25,056 \| 🐛 445 \| 🌐 C \| 📅 2026-08-12        |   active   |      c     |              localfs             |     tcp    |             sql             |   agpl-3.0  |
|      Tgres      |              <https://github.com/tgres/tgres> ⭐ 513 \| 🐛 5 \| 🌐 Go \| 📅 2021-12-22             |    dead    |     go     |            postgresql            |     tcp    |             sql             |  apache-2.0 |
|      Thanos     |         <https://github.com/thanos-io/thanos> ⭐ 14,175 \| 🐛 875 \| 🌐 Go \| 📅 2026-08-11        |   active   |     go     |            localfs,s3            |  http,grpc |            promql           |  apache-2.0 |
|     Timebala    |          <https://github.com/mattbostock/timbala> ⭐ 91 \| 🐛 48 \| 🌐 Go \| 📅 2018-02-11         |    dead    |     go     |              localfs             |    http    |            promql           |  apache-2.0 |
|      Timely     |   <https://github.com/NationalSecurityAgency/timely> ⭐ 395 \| 🐛 20 \| 🌐 Java \| 📅 2026-05-13   | maintained |    java    |           hdfs,accumulo          |    http    |             json            |  apache-2.0 |
|   TimescaleDB   |       <https://github.com/timescale/timescaledb> ⭐ 23,313 \| 🐛 381 \| 🌐 C \| 📅 2026-08-12      |   active   |      c     |            postgresql            |  postgres  |             sql             |  apache-2.0 |
...
| VictoriaMetrics | <https://github.com/VictoriaMetrics/VictoriaMetrics> ⭐ 17,521 \| 🐛 769 \| 🌐 Go \| 📅 2026-08-12 |   active   |     go     |              localfs             |    http    |       promql,metricsql      |  apache-2.0 |
...
* [awesome big data](https://github.com/onurakpolat/awesome-bigdata#time-series-databases) ⭐ 14,532 | 🐛 2 | 📅 2026-07-31
* [awesome db](https://github.com/numetriclabz/awesome-db) ⭐ 1,377 | 🐛 38 | 📅 2024-03-04
* [dbdb.io](https://github.com/cmu-db/dbdb.io) ⭐ 574 | 🐛 36 | 🌐 Python | 📅 2026-08-09 A database for all the databases by [@apavlo](https://github.com/apavlo) from [CMU DB](https://db.cs.cmu.edu/)
