...
|      Atlas      |          <https://github.com/Netflix/atlas> ⭐ 3,564 \| 🐛 8 \| 🌐 Scala \| 📅 2026-08-28          | maintained |    scala   |              memory              |    http    |            stack            |  apache-2.0 |
...
|      Citus      |         <https://github.com/citusdata/citus> ⭐ 12,740 \| 🐛 1,064 \| 🌐 C \| 📅 2026-08-28        |   active   |      c     |            postgresql            |     tcp    |             sql             |   agpl-3.0  |
|    ClickHouse   |     <https://github.com/ClickHouse/ClickHouse> ⭐ 49,569 \| 🐛 7,281 \| 🌐 C++ \| 📅 2026-08-31    |   active   |     c++    |              localfs             |     tcp    |             sql             |  apache-2.0 |
|      Cortex     |       <https://github.com/cortexproject/cortex> ⭐ 5,857 \| 🐛 352 \| 🌐 Go \| 📅 2026-08-31       |   active   |     go     |  s3,cassandra,bigtable,dynamodb  |    http    |            promql           |  apache-2.0 |
|     CrateDB     |           <https://github.com/crate/crate> ⭐ 4,433 \| 🐛 321 \| 🌐 Java \| 📅 2026-08-31          |   active   |    java    |         elasticsearch,s3         |     tcp    |             sql             |  apache-2.0 |
...
|     InfluxDB    |     <https://github.com/influxdata/influxdb> ⭐ 31,732 \| 🐛 2,157 \| 🌐 Rust \| 📅 2026-08-28     |   active   |     go     |              localfs             |    http    |        influxql,flux        |     mit     |
|      IoTDB      |     <https://github.com/apache/incubator-iotdb> ⭐ 6,387 \| 🐛 723 \| 🌐 Java \| 📅 2026-08-31     |   active   |    java    |           hdfs,localfs           |     tcp    |             sql             |  apache-2.0 |
...
|        M3       |              <https://github.com/m3db/m3> ⭐ 4,895 \| 🐛 225 \| 🌐 Go \| 📅 2026-08-17             |   active   |     go     |              localfs             |    http    | promql,graphite,m3query,sql |  apache-2.0 |
...
|   Apache Pinot  |    <https://github.com/apache/incubator-pinot> ⭐ 6,128 \| 🐛 1,389 \| 🌐 Java \| 📅 2026-08-31    |   active   |    java    |           s3,hdfs,azdls          |    http    |             pql             |  apache-2.0 |
...
|    Prometheus   |      <https://github.com/prometheus/prometheus> ⭐ 65,924 \| 🐛 882 \| 🌐 Go \| 📅 2026-08-31      |   active   |     go     |              localfs             | prometheus |            promql           |  apache-2.0 |
|     QuestDB     |        <https://github.com/questdb/questdb> ⭐ 17,293 \| 🐛 943 \| 🌐 Java \| 📅 2026-08-31        |   active   |    java    |              localfs             |  postgres  |             sql             |  apache-2.0 |
...
|      Thanos     |         <https://github.com/thanos-io/thanos> ⭐ 14,195 \| 🐛 889 \| 🌐 Go \| 📅 2026-08-26        |   active   |     go     |            localfs,s3            |  http,grpc |            promql           |  apache-2.0 |
...
|   TimescaleDB   |       <https://github.com/timescale/timescaledb> ⭐ 23,452 \| 🐛 392 \| 🌐 C \| 📅 2026-08-31      |   active   |      c     |            postgresql            |  postgres  |             sql             |  apache-2.0 |
...
| VictoriaMetrics | <https://github.com/VictoriaMetrics/VictoriaMetrics> ⭐ 17,623 \| 🐛 773 \| 🌐 Go \| 📅 2026-08-31 |   active   |     go     |              localfs             |    http    |       promql,metricsql      |  apache-2.0 |
...
* [awesome big data](https://github.com/onurakpolat/awesome-bigdata#time-series-databases) ⭐ 14,604 | 🐛 4 | 📅 2026-07-31
* [awesome db](https://github.com/numetriclabz/awesome-db) ⭐ 1,379 | 🐛 39 | 📅 2024-03-04
* [dbdb.io](https://github.com/cmu-db/dbdb.io) ⭐ 577 | 🐛 36 | 🌐 Python | 📅 2026-08-27 A database for all the databases by [@apavlo](https://github.com/apavlo) from [CMU DB](https://db.cs.cmu.edu/)
