...
|      Atlas      |          <https://github.com/Netflix/atlas> ⭐ 3,563 \| 🐛 8 \| 🌐 Scala \| 📅 2026-08-21          | maintained |    scala   |              memory              |    http    |            stack            |  apache-2.0 |
...
|      Citus      |         <https://github.com/citusdata/citus> ⭐ 12,719 \| 🐛 1,064 \| 🌐 C \| 📅 2026-08-22        |   active   |      c     |            postgresql            |     tcp    |             sql             |   agpl-3.0  |
|    ClickHouse   |     <https://github.com/ClickHouse/ClickHouse> ⭐ 49,391 \| 🐛 7,011 \| 🌐 C++ \| 📅 2026-08-22    |   active   |     c++    |              localfs             |     tcp    |             sql             |  apache-2.0 |
|      Cortex     |       <https://github.com/cortexproject/cortex> ⭐ 5,851 \| 🐛 359 \| 🌐 Go \| 📅 2026-08-21       |   active   |     go     |  s3,cassandra,bigtable,dynamodb  |    http    |            promql           |  apache-2.0 |
|     CrateDB     |           <https://github.com/crate/crate> ⭐ 4,425 \| 🐛 330 \| 🌐 Java \| 📅 2026-08-21          |   active   |    java    |         elasticsearch,s3         |     tcp    |             sql             |  apache-2.0 |
...
|      Flint      |         <https://github.com/twosigma/flint> ⭐ 1,176 \| 🐛 44 \| 🌐 Scala \| 📅 2020-07-03         | maintained |    scala   |               spark              |    http    |             json            |  apache-2.0 |
...
|     InfluxDB    |     <https://github.com/influxdata/influxdb> ⭐ 31,709 \| 🐛 2,148 \| 🌐 Rust \| 📅 2026-08-20     |   active   |     go     |              localfs             |    http    |        influxql,flux        |     mit     |
|      IoTDB      |     <https://github.com/apache/incubator-iotdb> ⭐ 6,383 \| 🐛 747 \| 🌐 Java \| 📅 2026-08-22     |   active   |    java    |           hdfs,localfs           |     tcp    |             sql             |  apache-2.0 |
...
|        M3       |              <https://github.com/m3db/m3> ⭐ 4,895 \| 🐛 220 \| 🌐 Go \| 📅 2026-08-17             |   active   |     go     |              localfs             |    http    | promql,graphite,m3query,sql |  apache-2.0 |
...
|   Apache Pinot  |    <https://github.com/apache/incubator-pinot> ⭐ 6,124 \| 🐛 1,421 \| 🌐 Java \| 📅 2026-08-22    |   active   |    java    |           s3,hdfs,azdls          |    http    |             pql             |  apache-2.0 |
...
|    Prometheus   |      <https://github.com/prometheus/prometheus> ⭐ 65,769 \| 🐛 916 \| 🌐 Go \| 📅 2026-08-22      |   active   |     go     |              localfs             | prometheus |            promql           |  apache-2.0 |
|     QuestDB     |        <https://github.com/questdb/questdb> ⭐ 17,270 \| 🐛 920 \| 🌐 Java \| 📅 2026-08-22        |   active   |    java    |              localfs             |  postgres  |             sql             |  apache-2.0 |
...
|     TDengine    |         <https://github.com/taosdata/TDengine> ⭐ 25,079 \| 🐛 448 \| 🌐 C \| 📅 2026-08-21        |   active   |      c     |              localfs             |     tcp    |             sql             |   agpl-3.0  |
|      Tgres      |              <https://github.com/tgres/tgres> ⭐ 513 \| 🐛 5 \| 🌐 Go \| 📅 2021-12-22             |    dead    |     go     |            postgresql            |     tcp    |             sql             |  apache-2.0 |
|      Thanos     |         <https://github.com/thanos-io/thanos> ⭐ 14,181 \| 🐛 878 \| 🌐 Go \| 📅 2026-08-22        |   active   |     go     |            localfs,s3            |  http,grpc |            promql           |  apache-2.0 |
...
|   TimescaleDB   |       <https://github.com/timescale/timescaledb> ⭐ 23,400 \| 🐛 394 \| 🌐 C \| 📅 2026-08-20      |   active   |      c     |            postgresql            |  postgres  |             sql             |  apache-2.0 |
...
| VictoriaMetrics | <https://github.com/VictoriaMetrics/VictoriaMetrics> ⭐ 17,579 \| 🐛 778 \| 🌐 Go \| 📅 2026-08-22 |   active   |     go     |              localfs             |    http    |       promql,metricsql      |  apache-2.0 |
...
* [awesome big data](https://github.com/onurakpolat/awesome-bigdata#time-series-databases) ⭐ 14,538 | 🐛 3 | 📅 2026-07-31
* [awesome db](https://github.com/numetriclabz/awesome-db) ⭐ 1,377 | 🐛 38 | 📅 2024-03-04
* [dbdb.io](https://github.com/cmu-db/dbdb.io) ⭐ 576 | 🐛 36 | 🌐 Python | 📅 2026-08-21 A database for all the databases by [@apavlo](https://github.com/apavlo) from [CMU DB](https://db.cs.cmu.edu/)
